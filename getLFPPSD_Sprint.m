function [] = getLFPPSD_Sprint(tmpSUB , Hemi , saveLOC)
...
opt.WinLength = 0.5;                  % STFT window length (this is one second) % was 1 originally 
...
folderLOC = ['Y:\LossAversion\Patient folders\' ,  tmpSUB, '\NeuroPhys_Processed\'];
%
% folderLOC = rawLOC;
...
saveNAME = [tmpSUB , '_Night',parts{3},'_SPRINT.mat'];
save(saveNAME,"lfpDataSprint",'-v7.3');
